...
import {leftTurn, flip, canDrop, dropPieceOnBoard, removePieceAt,
    candidatePlacements, turnedPlacements, allPlacementsOf} from "./controller.js";
...
test(allPlacementsOf(0).length === 192);

test(allPlacementsOf(1).length === 152);
dropPieceOnBoard(0,0,0,0,0);        // dropping a piece leaves fewer options for the next piece
test(allPlacementsOf(1).length === 112);
